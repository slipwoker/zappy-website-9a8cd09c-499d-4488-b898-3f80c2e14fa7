document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    function getFieldError(field) {
      ...
      if ((name.toLowerCase().includes('name') || field.dataset.minlength) && value !== '') {
        const minLen = parseInt(field.dataset.minlength || (name.toLowerCase().includes('name') ? 2 : 0), 10);
  ...
  (function applyRTL() {
    ...
    if (isRTL) {
      ...
      // Adjust scroll animation direction for RTL
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9a8cd09c-499d-4488-b898-3f80c2e14fa7',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9a8cd09c-499d-4488-b898-3f80c2e14fa7';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9a8cd09c-499d-4488-b898-3f80c2e14fa7';
